...
class createEssentialChannels(ui.Select):
  def __init__(self, channels, response):
    ...
    self.options = [
      discord.SelectOption(label="Sim", description="Você me permite criar os canais.", emoji="✅", value=1),
      discord.SelectOption(label="Não", description="Você não me permite a criar os canais.", emoji="❌", value=0)
    ]
